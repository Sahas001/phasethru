...
const Auth = () => {
  ...
  return (
    <div className="auth-page">
      <div className="auth-theme-btn" style={{ position: 'absolute', top: '1.5rem', right: '1.5rem' }}>
        <ThemeToggle />
      </div>
      ...
      <div className="auth-container">
        <div className="auth-header">
          ...
          <h2>
            ...
            <span className="auth-inline-brand">
        ...
        <form className="auth-form" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="auth-field">
            <div className="auth-label-row">
              ...
              {!isSignUp && <a href="#" className="auth-forgot">Forgot?</a>}
            </div>
